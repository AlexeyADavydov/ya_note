...
# 3 Если при создании заметки не заполнен slug, то он 
# формируется автоматически, с помощью функции pytils.translit.slugify.

# 4 Пользователь может редактировать и удалять свои заметки, но 
# не может редактировать или удалять чужие.

# Домашнее задание
# Напишите на pytest тесты логики проекта YaNews.
